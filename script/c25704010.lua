...
function s.initial_effect(c)
	...
	c:RegisterEffect(e0)
	--Special summon 1 "Westward" monster from deck
	...
	c:RegisterEffect(e1)
	--Return 1 "Westward" and 1 card on field to the hand
...
function s.cfilter(c,tp)
	return c:IsSetCard(0xc3b) and c:IsReason(REASON_BATTLE+REASON_EFFECT)
...
function s.thfilter1(c,rc)
	return c:IsFaceup() and c:IsSetCard(0xc3b) and c:IsAbleToHand()
