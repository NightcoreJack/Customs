...
function cid.atkcon(e)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsCode,25704865),e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
function cid.filter(c)
	return ((c:IsSetCard(0x41a) and c:IsType(TYPE_SPELL+TYPE_TRAP)) or c:IsCode(62966332)) and (c:IsFaceup() or c:IsLocation(LOCATION_GRAVE+LOCATION_DECK))
end
